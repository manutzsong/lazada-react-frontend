...
export default class App extends React.Component {
  ...
  authMe = () => {
    ...
    let url = "https://manutzsong-laz.duckdns.org/#/success";
    if (chromeToken) {
      if (addon && chrome_path) {
        console.log(chrome_path);
        url = `https://manutzsong-laz.duckdns.org/#/success?addon=true&chrome_path=${chrome_path}&chromeToken=${chromeToken}`;
      }
      else {
        url = `https://manutzsong-laz.duckdns.org/#/success?chromeToken=${chromeToken}`;
      }
